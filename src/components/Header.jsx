...
function Header(props) {
    return (
        <div className="bg-gray-200 shadow-sm"
             id="header">
            <div className="flex m-auto justify-between max-w-[1200px] relative"
                 id="header-content">
                <h1 className="inline-block p-4 text-2xl font-bold"
                    id="header-title">
                    CJY's Portfolio
                </h1>
                <div className="flex absolute left-0 top-[64px]"
                     id="header-nav">
                    <ul className="px-8 md:flex items-center gap-9">
